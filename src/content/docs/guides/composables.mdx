...
<div class="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-4">
  ...
  <PreviewCard
    ...
    src="/thumbs/formrepeater.mp4"
  />
  <PreviewCard
    client:idle
    title="Stepped Form Flow"
    description="Allows users to navigate through a form in a linear or non-linear way divided into steps."
    link="/guides/forms/stepped-form-flow/"
    src="/thumbs/steppedform.mp4"
  />
</div>
