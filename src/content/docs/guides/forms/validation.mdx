...
- `isTouched`: A boolean indicating if the field has been interacted with.
- `isBlurred`: A boolean indicating if the field has been blurred.
- `isValid`: A boolean indicating if the field is valid.
- `isValidated`: A boolean indicating if the field has been validated once due to user interaction.
