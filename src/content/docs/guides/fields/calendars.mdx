...
In order to deliver true i18n for international audiences, Formwerk calendar component depends on [@internationalized/date](https://react-spectrum.adobe.com/internationalized/date/index.html) to provide these functionalities.

If you do not use Calendar or Date Field components, the dependency will not be included in your bundle as it is fully tree-shakable.
...
<template>
  <Calendar label="Calendar" :calendar="calendar" locale="ar-EG" />
</template>
```
